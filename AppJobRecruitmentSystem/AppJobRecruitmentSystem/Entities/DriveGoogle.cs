    ...
    public class DriveGoogle
    {
        /*     static string ApplicationName = "Drive API .NET Quickstart";
             ...
             public async Task<DriveService> GetService()
             {
                ...
                // this.DownloadDirectoryName = pDownloadDirectoryName;

                // var credentials = DownloadDirectoryName+ "credentials.json";
                 using (var stream =
                     new FileStream(@"C:\Users\Maykol\Documents\Software deveploment\Asp .net\MVC\JobRecruitmentSystem\AppJobRecruitmentSystem\AppJobRecruitmentSystem\App_Data\credentials.json", FileMode.Open, FileAccess.Read))
                 {
